...
Despite various prior works on adversarial 3D physical attacks in AVs, all of them are simulating placing obstacles in the road with synthesized scene.
...
The real-world sensor perception is much more complicated. In this project, we present the study of authenticity issues of rendering-based synthesized scene in AV systems.
We evaluate this by generating different synthesized scene and testing the performance of neural network on them.
...
\textbf{We design a comprehensive test suite aiming at evaluating the whether the method to integrate an 3D object in the road background is realistic or not.
